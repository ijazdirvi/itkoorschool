        ...
        if ($param1 == 'import_excel') {
            ...
            foreach ($xlsx->rows() as $r) {
                ...
                for ($i = 0; $i < $num_cols; $i++) {
                    ...
                    //echo date("d-m-Y",($r[$i] - 25569) * 86400);
                        $data['birthday'] = date("d-m-Y", ($r[$i] - 25569) * 86400);
                    //}
                    else if ($i == 2)
                        $data['sex'] = $r[$i];
                    else if ($i == 3)
                    ...
                    //parent data ....
                        ...
                        $data3['password'] = sha1($r[$i]);
                    else if ($i == 11)
                        $data3['phone'] = $r[$i];
                    else if ($i == 12)
                        $data3['address'] = $r[$i];
                    else if ($i == 13)
                        $data3['profession'] = $r[$i];
                }
...
function noticeboard($param1 = '', $param2 = '', $param3 = '') {
    ...
    if ($param1 == 'create') {
        ...
        $this->sendPushNotification($data['notice']);
...
define('databaseName', 'dmedia_sch');
