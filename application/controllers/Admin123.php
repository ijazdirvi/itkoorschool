...
//  Loop through each row of the worksheet in turn
            for ($row = 2; $row <= $highestRow; $row++) {
                ...
                foreach ($rowData as $r) {
                    ...
                    $data3 = array();
                    $data4 = array();
                    $data['admission_date'] = date("Y-m-d", strtotime($r[0]));

                    $data['name'] = $r[2];
                    $data['birthday'] = date("Y-m-d", strtotime($r[4]));
                    $data['dob_in_words'] = $r[5];
                    $data['caste'] = $r[6];
                    $data['sex'] = $r[13];
                    $data['address'] = $r[8];
                    $data['phone'] = $r[14];
                    $data['email'] = strtolower(str_replace(" ", "", $r[2])) . "" . $r[1] . "@smswari.com";
                    $data['status'] = $r[9] !== 0 ? 1 : 0;
                     ...
                     */
                    $data2['roll'] = $r[1];
                    $data2['status'] = $r[9] !== 0 ? 1 : 0;

                    //parent data ....
                    $data3['name'] = $r[3];
                    $data3['profession'] = $r[7];
                    $data3['address'] = $r[8];
                    $data3['email'] = strtolower(str_replace(" ", "", $r[3])) . "" . $r[1] . "@smswari.com";
                    ...
                    if ($r[9] != '') {
                        $data4['reg_no'] = $r[1];
                        $data4['dues'] = $r[11];
                        $data4['withdraw_class'] = $r[9];
                        $data4['withdraw_date'] = $r[10];
                        $data4['remarks'] = $r[12];
...
function sendPushNotification($pushMessage) {
    $registration_ids = "euKGZNOAq1Q:APA91bHoOhgkbWhxN1V2hXUzKq681zoaHqXYd4UVdTvGfDtPb34FOeyNQFzXgFKEnBt6cyA_akwo6v8r9uyIon57ueGSEOWiCSzYR11qAwlXaISbG_Ldw-oQgIqiY4tSuGMb53smoFto";
//    $registration_ids = "cnNa7N2PoG4:APA91bH5VBTH0a5zUtYatx4CweBIKgcU2GSGgf3oFygI6KV91ZewtfjGCmUM16RLnSld4A-g2-bD88_jaFlzREKQOMbbVT23KyQ1JP3ZpFfroRlWSquRkGGQaUs7TZcJFashvZ7rK26C";
