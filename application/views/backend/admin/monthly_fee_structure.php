        ...
        <ul class="nav nav-tabs bordered">
            ...
            <li class="active">
                ...
                <a href="#list" data-toggle="tab"><i class="entypo-menu"></i> 
                    ...
                    <?php echo get_phrase('monthly_fee_list'); ?>
            ...
            <li>
                ...
                <a href="#add" data-toggle="tab"><i class="entypo-plus-circled"></i>
                    ...
                    <?php echo get_phrase('add_monthly_fee'); ?>
...
<th><div><?php echo get_phrase('Action'); ?></div></th> 
                    ...
                    <tbody>
                        ...
                        <?php
                        $count = 1;
                        foreach ($monthly_fee_structure as $row):
                            ?>
...
<?php echo form_open(base_url() . 'index.php?admin/monthly_fee_structure/create', array('class' => 'form-horizontal form-groups-bordered validate', 'target' => '_top')); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                ...
                                <select name="class_id" class="form-control" style="width:100%;">
                                    ...
                                    <?php
                                    $levels = $this->db->get('class')->result_array();
