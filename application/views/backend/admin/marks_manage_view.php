...
<div class="row">	
    ...
    <div class="col-md-2">	
        <div class="form-group">		
            ...
            <select name="class_id" class="form-control selectboxit" onchange="get_class_subject(this.value)">				<option value=""><?php echo get_phrase('select_class'); ?></option>				<?php
    ...
    <div id="subject_holder">	
        <div class="col-md-2">	
            ...
            <div class="form-group">	
                ...
                <select name="section_id" id="section_id" class="form-control selectboxit">					<?php
    ...
    <div class="col-sm-4">	
        <div class="tile-stats tile-gray">		
            ...
            <h3 style="color: #696969;">
                <?php echo get_phrase('marks_for'); ?> <?php echo $this->db->get_where('exam', array('exam_id' => $exam_id))->row()->name; ?></h3>
...
<div class="row">	
    ...
    <div class="col-md-8">		
        <?php echo form_open(base_url() . 'index.php?admin/marks_update/' . $exam_id . '/' . $class_id . '/' . $section_id . '/' . $subject_id); ?>			<table class="table table-bordered">			
            <thead>					
            ...
            <tbody>		
                ...
                endforeach; ?>	
                    <tr style="background-color:  antiquewhite">
                        <td colspan="4" class="text-center" > <b> Total Marks </b> </td>
                         <td colspan="3"> <input type="text" class="form-control" name="mark_total"		
                                   value="<?php echo $totalmarks ; ?>"> </td>
                    </tr>
            </tbody>		
        </table>		
        <center>	
...
<script type="text/javascript">
    function get_class_subject(class_id) {
        ...
        $.ajax({url: '<?php echo base_url(); ?>index.php?admin/marks_get_subject/' + class_id, success: function (response) {
