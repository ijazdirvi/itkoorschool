...
<div class="panel-body">				                              
 ...
 <div class="form-group ">					
    <label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('DOB in words');?></label>                        						
       <div class="col-sm-5">							
          <input type="text" class="form-control" name="dob_inwords"   value="">		
 		</div>			
</div>                                        
 
 <div class="form-group">						
    <label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('admission date');?></label>                        						
        <div class="col-sm-5">							
