<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
       ...
       <li class="<?php// if ($page_name == 'invoice') echo 'opened active';?> ">
        ...
        <li class="<?php if ($page_name == 'student_transaction') echo 'opened active'; ?> ">
            <a href="#">
                <i class="entypo-credit-card"></i>
                <span><?php echo get_phrase('fee transactions'); ?></span>
            </a>
            <ul>
                <?php foreach ($children_of_parent as $row):?>
                <li class="<?php if($page_name == 'student_transaction') echo 'active';?>">
                    <a href="<?php echo base_url(); ?>index.php?parents/student_transaction/<?php echo $row['student_id'];?>">
                      <span><i class="entypo-dot"></i> <?php echo $row['name'];?></span>
                    </a>
                </li>
                <?php endforeach;?>
        ...
        <!--STUDENT FEE DETAIL-->
        <li class="<?php if ($page_name == 'transaction_detail') echo 'opened active'; ?> ">
            <a href="#">
                <i class="entypo-credit-card"></i>
                <span><?php echo get_phrase('fee detail'); ?></span>
            </a>
            <ul>
                <?php foreach ($children_of_parent as $row):?>
                <li class="<?php if($page_name == 'transaction_detail') echo 'active';?>">
                    <a href="<?php echo base_url(); ?>index.php?parents/transaction_detail/<?php echo $row['student_id'];?>">
                      <span><i class="entypo-dot"></i> <?php echo $row['name'];?></span>
                    </a>
                </li>
                <?php endforeach;?>
